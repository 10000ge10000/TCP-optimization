...
OpenWrt 单项 buffer 上限：总内存不超过 128/256/512/1024 MiB 时分别为 4/8/16/32 MiB；更高内存为 `min(64MiB, 总内存5%)`。Linux 按内存分档取 6%～15%（≤256MiB 6%、≤512MiB 8%、≤1GiB 10%、≤2GiB 12%、更高 15%；激进模式且内存大于 512MiB 时再加 3%），并夹在 4MiB～256MiB 之间。
